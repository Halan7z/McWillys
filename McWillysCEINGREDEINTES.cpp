...
public:
    ...
    void generarFacturaCLIENTE(const Orden& orden, informacionCajero& info);
    void generarFacturaCLIENTEAFILIADO(const Orden& orden, informacionCajero& info);
...
void afiliarseRestaurante(vector<ClienteAfiliado>& clientesAfiliados);
bool verificarAfiliacionCliente(const vector<ClienteAfiliado>& clientesAfiliados, const string& carnetONit);
void aplicarBeneficios(Orden& orden);
            ...
            case 3: {
                ...
                while (true) {
                    ...
                    switch (opcionComprador)
                    {
                        ...
                        case 2:
                            system("cls");
                            afiliarseRestaurante(clientesAfiliados); // Pasar clientesAfiliados por referencia
                            break;
                        case 3:
                            system("cls");
...
void mostrarInventario(const char *archivo) {
    ...
    cout << "+--------------------------+---------------------+" << endl;
    cout << "| " << left << setw(25) << "Producto" << "| " << setw(10) << right << "       Unidades     |" << endl;
    cout << "+--------------------------+---------------------+" << endl;
    ...
    while (getline(readFile, line)) {
        ...
        cout << "| " << left << setw(25) << producto << "| " << setw(10) << right << cantidad << " unidades |" << endl;
    }
...
void menu::mostrarMenuHamburguesas(Orden& orden, informacionCajero& info) {
    ...
    cout << "16. Alan's Burger - 77Bs" << endl;
    ...
    do {
        ...
        switch (opcion) {
            ...
            case 6:
                ...
                bool esAfiliado = esClienteAfiliado(info, orden.carnetONit);
                ...
                // Generar factura
                generarFacturaCLIENTE(orden, info);
...
void menu::generarFacturaCLIENTE(const Orden& orden, informacionCajero& info) {
    system("cls");
...
bool verificarAfiliacionCliente(const vector<ClienteAfiliado>& clientesAfiliados, const string& carnetONit) {
    return find_if(clientesAfiliados.begin(), clientesAfiliados.end(),
        [carnetONit](const ClienteAfiliado& cliente) {
            return cliente.carnetIdentidad == carnetONit;
        }) != clientesAfiliados.end();
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
void aplicarBeneficios(Orden& orden) {
